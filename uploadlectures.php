          ...
          <div class="row">
           ...
           <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
	<h4 class="card-title">This section allows you to upload lectures</h4>

<form action="uploadl.php" method="post"
            name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">		
				...
				<div class="form-group row">
									<label for="id" class="col-sm-3 col-form-label"> Choose Excel
                    File</label>
									<div class="col-sm-9">
                ...
                <button type="submit" id="submit" name="import"
                     class="btn btn-success btn-fw">Import</button>

...
?>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Number of Lectures</p>
                      <div class="fluid-container">
					  <?php
					    $nbr = $conn->query("SELECT COUNT(id)FROM courses_lectures where course_id=$id "); 
         ...
         <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
	<h4 class="card-title">This section allows you to upload a lecture</h4>
 
<form action="addl.php" method="post" id="submitlecture"
            name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">		
                           <input type="hidden" value="<?=$id?>" name="id"/>

			
			<div class="form-group row">
									<label for="id" class="col-sm-3 col-form-label"> Lecture Title </label>
									<div class="col-sm-9">
							<input name="ltitle" required type="text"/>
								</div>
				</div>
						<div class="form-group row">
									<label for="id"  class="col-sm-3 col-form-label"> Choose 
                    File</label>
									<div class="col-sm-9">
					<input type="file" required name="Filename" id="lecturefile" >
									</div>
													</div>
                ...
                <button type="submit" id="submit" name="addlecture"
                     class="btn btn-success btn-fw">Add Lecture</button>

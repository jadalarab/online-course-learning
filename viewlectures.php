                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
					  ...
					  <?php
					    ...
					    $nbr = $conn->query("SELECT COUNT(id)FROM courses_lectures where course_id=$course_id "); 
...
<th class="th-sm">Create Exam
					   ...
					   <tbody>
					   <?php
							$info = $conn->query("select * from courses_lectures where course_id='$course_id'"); 
...
$lid=$values[0];
                        ...
                        <tr>
                         <td class="font-weight-medium">
                          ...
                          <td class="font-weight-medium">
                            <a href="<?=$path?>" download><?=$lecturename?></a>
                          </td>
								<td class="font-weight-medium">
			<?php $examdoneq=$conn->query("select * from exams where lecture_id='$lid'");
			$ct = $examdoneq->rowCount();
			if($ct==0){ ?>

				<form action="createexam.php" method="POST">
							<input type="hidden" value="<?=$lid?>" name="lecture_id"/>
							<input type="hidden" value="<?=$course_id?>" name="course_id"/>

                            <button type="submit" id="submit" 
							class="btn btn-success btn-fw">Create</button>
							</form>
<?php } else{ ?>
<p>Exam already Created. View it</p>
                <form action="viewexam.php" method="POST">
							<input type="hidden" value="<?=$lid?>" name="lecture_id"/>
														<input type="hidden" value="<?=$course_id?>" name="course_id"/>

                            <button type="submit" id="submit" 
							class="btn btn-success btn-fw">View</button>
							</form>  
...
<td class="font-weight-medium">
                            <form action="deletel.php" method="POST">
<input type="hidden" value="<?=$course_id?>" name="cid"/>

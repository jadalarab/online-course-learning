...
$conn = mysqli_connect("localhost","root","","finaldb");
	...
	$uquery=mysqli_query($conn,"select * from students where student_id='".$_SESSION['id']."'");
...
<body>
<div>
	<h4>Welcome, <?php echo $urow['username']; ?> <a href="logout.php">Logout</a></h4>
	<?php
		...
		while($row=mysqli_fetch_array($query)){
			?>
				...
				<form>
					...
					<input type="text" value="<?php echo $row['chat_room_id']; ?>" id="id">

        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h1 class="card-title">Quiz Questions</h1>
                  <div class="table-responsive">
				<form id="exam" action="saveexam.php" method="post">
				<input id="numberofquestions" name="numberofquestions" type="hidden"/>
							<input type="hidden" value="<?=$lecture_id?>" name="lid"/>
							<input type="hidden" value="<?=$course_id?>" name="course_id"/>

				<button type="submit" id="submit" 
                     class="btn btn-success btn-fw">Submit</button>
					</br></br>
				 <div id="questions">
					<button type="button" id="addq" 
                     class="btn btn-success btn-fw">Add Questions</button>
				</div>
				</form>
                  </div>
                </div>

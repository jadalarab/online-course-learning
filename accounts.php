                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Number of Students</p>
                      <div class="fluid-container">
					  <?php
					  
					    $nbr = $conn->query("SELECT COUNT(id)FROM students "); 
...
<th class="th-sm">Ac/Deactivate
					   ...
					   <tbody>
					   <?php
							$info = $conn->query("select * from students"); 
...
<?php if($activated==1){?>
                       <form action="accountstatus.php" method="POST">
<input type="hidden" value="<?=$sid?>" name="sid"/>


                            <button type="submit" id="submit" name="deactivate" 
                     class="btn btn-success btn-fw">Deactivate</button>
</form>
...
<input type="hidden" value="<?=$sid?>" name="sid"/>
                            ...
                            <button type="submit" id="submit" name="activate" 
                     class="btn btn-success btn-fw">Activate</button>
</form>
